...
## $k<3$
For situations where $k<3$, we cannot refuse the null hypothesis in the tests with form "$H_0: \beta = 0 \quad v.s. \quad H_1: \beta \neq 0$", where $\beta$ is any parameter corresponding to $1_{\{k=1\}}$. And the curves of the presses with respect to the SI score in Figure 5 also shows that we cannot distinguish pre-presses and post-presses significantly. This may be due to the fact that for short time windows there are hardly any button presses in each entry and thus there is not enough data. \newline
